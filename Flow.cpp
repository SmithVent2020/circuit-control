...
void Flow::read() {
  ...
  const long Vsupply     = 5;                    // voltage supplied, mv
  const long sensorMin   = 1023L * 0.5 / Vsupply;  // Sensor value at 500 mv
  const long sensorMax   = 1023L * 4.5 / Vsupply; // Sensor value at 4500 mv
